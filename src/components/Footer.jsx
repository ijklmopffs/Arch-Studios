...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="bg-veryLightGrey hidden w-[768px] lg:flex items-center gap-16 font-bold text-lg text-mediumGrey relative"
    >
      <div className="bg-veryDarkBlue flex justify-center items-center w-52 h-52">
      ...
      <Link to="/portfolio">
        <button className="flex items-center gap-4 bg-veryDarkBlue p-4 text-white absolute -right-24 bottom-16 hover:bg-darkGrey">
          See our portfolio
